...
<img id="title" src="images/publicLibrary.png" alt="Public Library">
...
<div class="container">
    <header class="clearfix">
        <span class="support-note" style="text-align: center; font-size: 15pt; color: white">These books have been read by the community! <br> Click on a book to read about it! (Best viewed in WebKit browsers)</span>
    </header>
    <div class="main">
...
<script>
    async function fetchBooksAndCreateISBNArray() {
        try {
            const response = await fetch('<?= ($BASE) ?>/api/read-books'); // Fetch the books data
            ...
            return isbnList; // Log the array to the console
            // Here you can use isbnList for further processing or pass it to another function
        } catch (error) {
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        const isbnList = await fetchBooksAndCreateISBNArray();
                    ...
                    <div class="bk-book book-${bookCounter}">
                        ...
                        <div class="bk-page">
                            ...
                            <div class="bk-content">
                                <img src="${bookDetails.imageLinks ? bookDetails.imageLinks.thumbnail : './images/hA3xftZF37smTyudpnxnFzvXkrc.jpeg'}" alt="Book Cover">
                            </div>
                            <div class="bk-content">
